...
<div class="main-container">
	...
	<div class="main-block moreinfo-section">
		<div class="container">
			<div class="section-title">تسويق رياضي</div>
			<div class="moreinfo-list row">
				...
				<div class="col col-md-4">
					<a class="section-item" href="<?php echo $url; ?>/communication/sport_marketing/premierleague/index.php"
						...
						<div class="desc">
							<div class="title">مانشستر سيتي</div>
						</div>
					</a>
				</div>
				<div class="col col-md-4">
	...
	<div class="main-block moreinfo-section">
		<div class="container">
			<div class="section-title">معلومات اكثر</div>
			<div class="moreinfo-list row">
		...
		<div class="container">
			<div class="video-list row">
				...
				<div class="col col-md-4">
					<div class="section-item">
						...
						<div class="desc">
							<div class="title">[NEXEN TIRE] لوريم ايبسوم دولار سيت أميتج </div>
						</div>
					</div>
				</div>
				<div class="col col-md-4">
				...
				<div class="col col-md-4">
					<div class="section-item">
						...
						<div class="desc">
							<div class="title">[Product] لوريم ايبسوم دولار سيت أميتج</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="btn-box">
				<a class="btn btn-ghost white" href="https://www.youtube.com/channel/UC7bke9V6vRL905dkf0jtbWw"
					target="_blank"><img src="<?php echo $url; ?>/assets/images/main/ico-video-btn.png" /><span> ذهاب يوتيوب </span></a>
			</div>
		</div>
	</div>
	...
	<div class="main-block sns-section">
		<div class="container">
			...
			<div class="read-more"><a onclick="social_list_more()"><span>اقرأ المزيد</span></a></div>
