		...
		<div class="container">
			...
			<div class="media-cont">
				...
				<div class="media-title">
					<div class="title"><strong>NEXEN TODAY <span>Webzine</span></strong> <span>Remain
							informed about all of NEXEN TIRE’s latest news as well as its variety of
							informative contents.<br /> Receive NEXEN Today Webzine regularly via
							email!</span></div>
				...
				<div class="webzine-top">
					<img src="__icsFiles/metafile/2017/12/28/webzine_keyvisual_1712.png" alt="" width="100%">
				</div>


				<div class="media-ip-box">
					<div class="title-line">
						<a href="index.php" class="btn-back-img"><img src="<?php echo $url; ?>/assets/images/common/form_back.gif"
								alt="Back"></a>
						<h4>Sign up for a subscription</h4> <span>The information you enter is used only for
							webzine shipment.</span>
					...
					<div class="ip-body">
						...
						<form class="request-form form-horizontal" id="requestForm">
							...
							<div class="btn-center">
								<button type="button" onclick="webzine_subscribe();"
